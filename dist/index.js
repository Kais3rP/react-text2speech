...
const Button = (_a) => {
    ...
    return (React__default["default"].createElement("button", Object.assign({ style: button }, props), children));
};
const CustomSelect = (_a) => {
    ...
    const titleStyle = {};
    return (React__default["default"].createElement("div", Object.assign({ style: Object.assign(Object.assign({}, container), props.style) }, props),
        React__default["default"].createElement(Button, { type: "button", onClick: show, styleOptions: styleOptions }, (_b = options.find((o) => o.value === value)) === null || _b === void 0 ? void 0 : _b.name),
        React__default["default"].createElement("div", { ref: ref, style: Object.assign(Object.assign({}, optionsStyle), { opacity: showOptions ? 1 : 0, pointerEvents: showOptions ? 'all' : 'none' }) },
            React__default["default"].createElement("div", { style: titleStyle }, title),
...
const Slider = (_a) => {
    ...
    return (React__default["default"].createElement(SliderContainer, Object.assign({}, props),
        icon && React__default["default"].createElement(Icon, null, icon),
        React__default["default"].createElement(StyledSlider, { min: data.min, max: data.max, step: data.step, type: "range", value: data.value, onChange: onChange })));
};
        ...
        !isMinimized && (React__default["default"].createElement(React__default["default"].Fragment, null,
            React__default["default"].createElement(OptionsContainer, null,
                React__default["default"].createElement("div", null,
                    ...
                    React__default["default"].createElement(BiDotsHorizontal, { onPointerDown: toggleSettings, className: "text-[0.8rem] text-colorExtra1 mb-[3px] p-[0px] cursor-pointer hover:text-colorExtra1" })),
                React__default["default"].createElement("div", { className: "w-[100px] flex items-center pt-1" },
                    React__default["default"].createElement(BiReset, { title: "reset", className: ` mr-2 font-bold cursor-pointer hover:text-[#D00] hover:bg-bgLight hover:text-colorLight transition-all text-[0.9rem]`, onClick: handleReset }),
                    React__default["default"].createElement("div", { className: "w-[70px]" },
